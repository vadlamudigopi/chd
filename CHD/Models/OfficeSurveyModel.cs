    ...
    public class OfficeSurveyModel
    {
        ...
        public bool updateUniqueId(int newId)
        {
            ...
            try
            {
                ...
                SqlCommand command;
                string sql;
                string uniqueID = "OFF" + DateTime.Now.ToString("hhmmss") + newId;
                sql = "UPDATE office_survey SET unique_id = @unique_id WHERE id = @id";
        ...
        public Boolean insert()
        {
            ...
            try
            {
                sql = "INSERT INTO office_survey (user_id,form_data,files,added_date) OUTPUT INSERTED.ID VALUES";
                ...
                {
                    CL.getLog("Fail to update with unique id to office Survey table.");
                    return false;
                }
                cnn.Close();
            }
            ...
            {
                CL.getLog("Fail to insert to office Survey " + e);
                return false;
            }
            return true;
        }
